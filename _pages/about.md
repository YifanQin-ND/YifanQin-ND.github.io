...
1. A hardware neural network batch normalization system  
   {CN202011251999.9 · Issued May 20, 2022}
1. A matrix-vector multiplication circuit and calculation method  
   {CN201910792384.8 · Issued Oct 8, 2021}

# ML Demo

* 06/2024 **Real-Time Ventricular Arrhythmia Detection: Efficient ML Inference System** — ACCESS Center, Hong Kong  \[[Video](https://www.youtube.com/watch?v=v08EoR8vLf0)\]
